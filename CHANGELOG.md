...
* Activate release so i can test ([34b7227](https://github.com/admknight/piko/commit/34b7227934bc77e024d37ae5f14b719a9d165288))
* add "SettingsStatusLoadFingerprint" to fingerprints of `Hide Community Notes` and `Hide Live Threads` patch ([9c0232a](https://github.com/admknight/piko/commit/9c0232afd684024cc7028960aa2c65a82ce90cb7))
* Add back settings for the custom sharemenu buttons ([bc7e777](https://github.com/admknight/piko/commit/bc7e777e59091801238d4692823415b0d7d2855b))
* Add support for 10.83.0 releases ([9344d52](https://github.com/admknight/piko/commit/9344d527d1ec5e0fd812bd835c45304a6619df95))
* Adding debug menu patch results in a crash ([caf82eb](https://github.com/admknight/piko/commit/caf82ebd95bd113dbd5cacda1deffa9194cb280b))
* **Bring back twitter:** Change the character "𝕏" into "Twitter". ([#441](https://github.com/admknight/piko/issues/441)) ([c20e16f](https://github.com/admknight/piko/commit/c20e16f80499df75176e9080f156e529f4f7d326))
* **Bring back twitter:** Change x icon to legacy twitter. ([3006f47](https://github.com/admknight/piko/commit/3006f47d973ffde1622ae1544590a11e923c68ab))
* **Bring back twitter:** Resource compilation fails on ReVanced Manager ([a364bec](https://github.com/admknight/piko/commit/a364becc7f6f70724c37b9499e79885fb09f0436))
* Change run config ([18d4dce](https://github.com/admknight/piko/commit/18d4dcebb67a568e460931c6cd2003a0df7ae5ec))
* **Custom download folder:** Restore compatibility with versions prior to 10.64 ([b88b00b](https://github.com/admknight/piko/commit/b88b00ba97632d62517c0e52a924c453ea022d7a))
* **Custom downloader:** Improve fingerprint ([2a2a4a4](https://github.com/admknight/piko/commit/2a2a4a4e2cdc6587c5c3b91bb3888918d7cd720d))
* **Custom sharing domain:** Now works on "Copy Link" ([8f71415](https://github.com/admknight/piko/commit/8f71415e2c7cb5cf351bbcf11d2942d5f0771995))
* **Enable Reader Mode:** Specify the compatible version, show a warning instead of throwing an exception when failed ([b1c52e7](https://github.com/admknight/piko/commit/b1c52e73daabe3222e925ba5d6b866af31a35045))
* **Feature Flags:** Use ListView instead of RecyclerView for a more reliable list. ([6f16b7f](https://github.com/admknight/piko/commit/6f16b7f7d61c81e7a21394f74b6e0d0e80ed9a55))
* Fix crash when opening feature flags ([2b1484d](https://github.com/admknight/piko/commit/2b1484d6c291a997283d98358cff98b0195acfed))
* Fix oopsie ([2af661f](https://github.com/admknight/piko/commit/2af661f5dfa1cc08e436ce04800ab230030a5079))
* **Hide FAB:** Add description ([ae418a8](https://github.com/admknight/piko/commit/ae418a83d94cbb1091ba9fec3ce07a8704ab5c00))
* **Hide For You:** Included by default ([3b51053](https://github.com/admknight/piko/commit/3b51053658847d9d4d1864c5664c5247dd029bcf))
* idk ([0a4ade0](https://github.com/admknight/piko/commit/0a4ade0e4cf65078cfbdde349c8f7ee92754067f))
* Improve getUsername fingerprint ([af617af](https://github.com/admknight/piko/commit/af617af523bfa7df00a232a51364ea9e8ea4d34f))
* Missing `,` ([67675fe](https://github.com/admknight/piko/commit/67675fe381f0554cb69c0f061ec792df9e523479))
* Not creating `values-night-v31` dir ([e3f3491](https://github.com/admknight/piko/commit/e3f3491fea403f55d5200d1afc4aebd5c7507c2e))
* Opening mod settings with root installation results in crash ([8161644](https://github.com/admknight/piko/commit/81616443f2104eb1633c2c92c555f45341a7680e))
* Opening mod settings with root installation results in crash ([47e7670](https://github.com/admknight/piko/commit/47e7670cc09da736cbca6c9447f82d9fa343ee56))
* refactor ([eab113e](https://github.com/admknight/piko/commit/eab113e471c2b588bbda05acba57e669a312f52c))
* Remove debug prints ([33e4d08](https://github.com/admknight/piko/commit/33e4d08a58451217781914953c1ffb711ea8480b))
* **Remove Detailed posts:** Change the settings label from "detailed" to "related" ([3cf5f9e](https://github.com/admknight/piko/commit/3cf5f9ec9e383deb17919f2b3c5254954502c825))
* Remove duplicate strings ([94c6642](https://github.com/admknight/piko/commit/94c66422e0ced2cbdfd820dfee60cedd2c68e636))
* **Remove Google Ad:** Include ads in the comments ([79d6e35](https://github.com/admknight/piko/commit/79d6e35144ffc6c81d3bb36499fc2c22e5a089ac))
* Remove obsolete `Open browser chooser on opening links` patch ([a1e2b76](https://github.com/admknight/piko/commit/a1e2b766a872c3ee2facef1444bfa92ab4236144))
* Remove semicolon ;-) ([46e60f7](https://github.com/admknight/piko/commit/46e60f71d3eefc2eb81fbca01451d52731c397c1))
* Resource strings getting corrupted, resulting on failure to patch on revanced manager ([#439](https://github.com/admknight/piko/issues/439)) ([1763137](https://github.com/admknight/piko/commit/1763137126b9a95df51fe23ce816853ccf0a8f44))
* switch jp to ja for Japanese translation ([c13cc87](https://github.com/admknight/piko/commit/c13cc87afeaea8cb623e7652a154a507ce532d61))
* tweet highlight color on hold ([#243](https://github.com/admknight/piko/issues/243)) ([b22ea42](https://github.com/admknight/piko/commit/b22ea426830b250abaa336e3b158dea34f82f6d6))
* **Twitter - Bring back twitter:** Add other languages ([2c63ff1](https://github.com/admknight/piko/commit/2c63ff1bc1444ed6d83f911becca4289001c306c))
* **Twitter - Bring back twitter:** Exclude by default ([e654549](https://github.com/admknight/piko/commit/e654549c95412b50932453732b215ebb097d4c19))
* **Twitter - Bring back twitter:** Now changes notification icon ([7e281e4](https://github.com/admknight/piko/commit/7e281e42f2c809ad669113b81f9f888b168882ca))
* **Twitter - Bring back twitter:** Now changes notification icon ([8b57a07](https://github.com/admknight/piko/commit/8b57a07dfb7ca6ce3d92af92b09f2a786e0544f2))
* **Twitter - Bring back twitter:** Now changes the app name by writing directly to AndroidManifest (Should make patching faster) ([f61468c](https://github.com/admknight/piko/commit/f61468c4cd1d42d7697a3179a4711dcb9ea01c9e))
* **Twitter - Custom sharing domain:** Disable by default ([6e7c170](https://github.com/admknight/piko/commit/6e7c17014b75d098eaef5ba3fbe4ed777eb416b1))
* **Twitter:** `Customize Navigation Bar items` in/from `10.53.0-beta.1` ([e8154fb](https://github.com/admknight/piko/commit/e8154fb0ffa91e6d3ed2812bed3f71a034f3bc01))
* **Twitter:** Add splash screen icon ([b30e083](https://github.com/admknight/piko/commit/b30e0838de4ac5f72848dcc813d477e52a6d3f1c))
* **Twitter:** Add support for version 10.64.0-beta.1 ([c81378d](https://github.com/admknight/piko/commit/c81378d80275465acbf9caed5f48235b56395d56))
* **twitter:** Add twitter to compatible package for SelectableTextPatch ([0b6ee33](https://github.com/admknight/piko/commit/0b6ee33a044433c498c7d522b92b33623dca1a93))
* **Twitter:** Bookmark in nav bar dix ([03fb96c](https://github.com/admknight/piko/commit/03fb96c485edb8931e9d37452f5a45c0b8a0103b))
* **Twitter:** Bookmark nav bar fix ([a6e8ab9](https://github.com/admknight/piko/commit/a6e8ab9c6817e15fa7c9ba182650f65ee2e65132))
* **Twitter:** Bring back download and viewcount patch ([3eea91f](https://github.com/admknight/piko/commit/3eea91f06a65433275bbd7437b290212654a308d))
* **Twitter:** Change patch name from `Enable app icon settings` -> `Enable app icons` ([5a7ef46](https://github.com/admknight/piko/commit/5a7ef469557e5cf4ecc9ce8465d73c20501dc524))
* **Twitter:** disable `Hide For You` by default. ([b933c19](https://github.com/admknight/piko/commit/b933c196f8325a02e82520419c049260cc3a4590))
* **Twitter:** Download patch ([f87dee7](https://github.com/admknight/piko/commit/f87dee798632528595ac3efab1349d7a3fecafa0))
* **twitter:** Exclude `Google Ads Patch` by default ([a26e03a](https://github.com/admknight/piko/commit/a26e03a157815445d8416a68dd43aa96b2859ce1))
* **Twitter:** fix `Control video auto scroll` in 10.57 ([b7ae78c](https://github.com/admknight/piko/commit/b7ae78cd61b2f75d266e3fe3d57c5c21cd798e79))
* **Twitter:** fix `Custom downloader` patch ([f4d953a](https://github.com/admknight/piko/commit/f4d953a3dc7cb8325e56e515cd38a8ab707d2162))
* **Twitter:** fix `Custom translator` patch ([8065fa3](https://github.com/admknight/piko/commit/8065fa32019d1d1bd4c9bd116f1774e345203356))
* **Twitter:** Fix `Customize profile tabs` crash after `10.43` ([a38d621](https://github.com/admknight/piko/commit/a38d6213e06404fde21f6b5b8eddfcdfe8edd73e))
* **Twitter:** fix `Enable app icon settings` patch ([c2b6f79](https://github.com/admknight/piko/commit/c2b6f79b5c833c2441432b2511374361318e5507))
* **Twitter:** fix `Enable debug menu for posts` patch ([72a72f2](https://github.com/admknight/piko/commit/72a72f2114d0ee9fe2cac0e5eae5b03e196dd6e2))
* **Twitter:** Fix `Hide nudge button` patch ([d7572fe](https://github.com/admknight/piko/commit/d7572feac66d44f0fe669073ee09bc09637adb9a))
* **Twitter:** Fix `Hide Promoted Trends` patch ([7052d25](https://github.com/admknight/piko/commit/7052d2583527354ee1a719f808993049364c8718))
* **Twitter:** fix `Reader mode` for 10.34 ([01cb8c9](https://github.com/admknight/piko/commit/01cb8c94c951c103f0ebea56f8daf88214eb77ae))
* **Twitter:** Fix `Remove premium upsell` patch ([4df5e32](https://github.com/admknight/piko/commit/4df5e32088eb57702c5f30e20b3c75d2ec11ee87))
* **Twitter:** fix `Remove videos for you` patch ([b19f943](https://github.com/admknight/piko/commit/b19f943ee8a19ea158e89cc031ae037e43da6e50))
* **Twitter:** Fix aapt breakage due to tag mismatch ([730a51c](https://github.com/admknight/piko/commit/730a51c20f464bbe2b680004721161dd5f34dadf))
* **Twitter:** fix video entity hook in `10.58` ([e8a833d](https://github.com/admknight/piko/commit/e8a833d2123b92a40caf68b4f6798e822a6d1737))
* **Twitter:** Fixup patch dependecy ([867926a](https://github.com/admknight/piko/commit/867926acccd1b768b63475aa79d376940a87e075))
* **Twitter:** Missing download option in immersive view ([6b0aa2c](https://github.com/admknight/piko/commit/6b0aa2c0d8d0f9192630e42abef418a834a95df0))
* **Twitter:** Only show settings category if patch is applied ([2141680](https://github.com/admknight/piko/commit/21416800ce7176c713b1521649d9760fcd450158))
* **twitter:** Refactor packages ([8a5cea6](https://github.com/admknight/piko/commit/8a5cea659350a774fe97ec52bc467f10ba1be341))
* **twitter:** Remove debug code ([2eb2fa3](https://github.com/admknight/piko/commit/2eb2fa34e101a6d838b28eabc3c0c7ae08af9dc4))
* **Twitter:** Share menu button add hook in/from 10.67 ([a640946](https://github.com/admknight/piko/commit/a640946e7045be359535ed0eead00ec80d2e10c4))
* unescaped character on `pl` string values ([a6444be](https://github.com/admknight/piko/commit/a6444bed45872df6a55be17a2b64dd2d40e2d16a))
* Unescaped characters ([8e539df](https://github.com/admknight/piko/commit/8e539dfd8c4e1ef6889357b9850a842db54a2a99))
* unshort url for 10.30 ([ef3e00f](https://github.com/admknight/piko/commit/ef3e00f80fc469e5f09f8d7e43136791dbd94872))
* update pr if it already exists ([6d616d2](https://github.com/admknight/piko/commit/6d616d20ea0a0a4880e5fb339dd569db1cc530a2))
* Update pull_request.yml[skip ci] ([30e1e4f](https://github.com/admknight/piko/commit/30e1e4f828e4018b3595ea99d21d2a527145b2f5))
* URL decode path to JAR containing spaces by osumatrix ([e6671ba](https://github.com/admknight/piko/commit/e6671ba4a8359db7aefa1ab20600e1f17144e002))
* Use UrlDecoder API available in older Android versions ([d9e6374](https://github.com/admknight/piko/commit/d9e63740b7eb7c8a4f44abf6d59998ea14194346))

### Features

* Add `Show poll results` patch ([7b48f1b](https://github.com/admknight/piko/commit/7b48f1b9da05deb9aae73f0982f65eb527666fdc))
* Add russian translation ([2dc9cee](https://github.com/admknight/piko/commit/2dc9ceed63a5a965f9979e3df1094f6b7a12a001))
* Add settings for `Disable chirp font` patch ([dad0a70](https://github.com/admknight/piko/commit/dad0a70b13a281937ea608e7866b20ae30863cb9))
* Add support for adding custom feature flags ([a6a91d1](https://github.com/admknight/piko/commit/a6a91d13a8623b505ba299ee23845f2a62399f33))
* Add support for patches.json ([f5f63a3](https://github.com/admknight/piko/commit/f5f63a330a06d03a10e1a3232d96764fc2d1ac7c))
* Add toggle for `Open browser chooser on opening links` patch ([6f217f0](https://github.com/admknight/piko/commit/6f217f08a8037be067791b318b750d7f6d91b4ea))
* Added resource file for strings ([181fd29](https://github.com/admknight/piko/commit/181fd298748c38dc53c10609b6714d8ce255d5be))
* **all:** Added `Export all activities` patch from ReVanced ([7cc405f](https://github.com/admknight/piko/commit/7cc405f7e900b85aaa172e8693cd4ca2e790451d))
* **Bring back twitter:** Add Japanese ([4eb08b5](https://github.com/admknight/piko/commit/4eb08b554eaf92958e0e159647fc71b35340e2b2))
* **ci:** Add updates and refactors to changelog ([5fb8ef7](https://github.com/admknight/piko/commit/5fb8ef7902e6be592305c34cf3add0f06e477a68))
* **Customize side bar items:** Allow for hiding of the "Jobs" item ([14ce811](https://github.com/admknight/piko/commit/14ce811a7b4d885fa6779524aad0b41034a2d8d0))
* Enable recent patches by default ([e84f358](https://github.com/admknight/piko/commit/e84f358e494830fdecdc3dd12662b5f5ccd644b3))
* **Hook feature flag:** Added ability to search for supported flags. ([28a2c0a](https://github.com/admknight/piko/commit/28a2c0a6ca97fa50711ce44cfa1f20b5147e906f))
* no t.co links ([776e700](https://github.com/admknight/piko/commit/776e7007b571cc2803d566891c72a42057297bb6))
* Quick settings button is now optional ([e9e54e5](https://github.com/admknight/piko/commit/e9e54e5e44437b92db9700c363f0abd9117cc325))
* Remove throw file ([86bff99](https://github.com/admknight/piko/commit/86bff993636928c67ca95dabeebcf1f5cc191a36))
* **Settings:** Add a description to "Native features" page ([be7aa54](https://github.com/admknight/piko/commit/be7aa5472c9b12ff6207992b21292b4fb4d337cf))
* **Show poll results:** Add a toggle on mod settings ([2624561](https://github.com/admknight/piko/commit/262456164e84d81b6c33436ac9f8fa21fa05e2ba))
* **Translations:** Add `Turkish` ([bf70b91](https://github.com/admknight/piko/commit/bf70b913775ec299a87725b15d30bb2506da7a5d))
* **Translations:** Add Arabic translations ([c1d797b](https://github.com/admknight/piko/commit/c1d797b21bcbf0752bb48c94e4009e8221e46b36))
* **Translations:** Add Brazilian Portuguese translations [Bring back Twitter] ([3a831d3](https://github.com/admknight/piko/commit/3a831d3869a5fbbb22342cbfe1859241b2126fa5))
* **Translations:** add hindi ( हिन्दी ) translations [#91](https://github.com/admknight/piko/issues/91) ([a766771](https://github.com/admknight/piko/commit/a766771d848a43c3a4d2ba5e955ab72015dfb69d))
* **Translations:** Add japanese ([c123d8e](https://github.com/admknight/piko/commit/c123d8ed58f92dce6337cd194be64e21b3d9559c))
* **Translations:** Add polish translation ([8102f35](https://github.com/admknight/piko/commit/8102f35bab392acd8337fdf363c8891e3b96f629))
* **Translations:** Add simplified Chinese translation ([7662a34](https://github.com/admknight/piko/commit/7662a34a87e2dd5d819188993054a8fc4808ef03))
* **Translations:** Add Simplified Chinese translations and Taiwanese Traditional Chinese translations[Bring back Twitter] ([d44bfd7](https://github.com/admknight/piko/commit/d44bfd73f0063703179c097d68738063a000d80b))
* **Translations:** Added Brazilian Portuguese [#90](https://github.com/admknight/piko/issues/90) ([ad307da](https://github.com/admknight/piko/commit/ad307da5ba7f0739024c7a30de2cb3b09d8aee28))
* **Translations:** Added Traditional Chinese translation ([1c0b10a](https://github.com/admknight/piko/commit/1c0b10af732a6e159862a99369b57368cbbdab91))
* **Translations:** Fix Simplified Chinese Translation ([ec0a3dc](https://github.com/admknight/piko/commit/ec0a3dcadf4027c3a6a6d411d44043d245b5ca29))
* **Translations:** Update `japanese` ([444623f](https://github.com/admknight/piko/commit/444623faaa5761b33445705e04e5c3078ff88124))
* **Translations:** Update `japanese` ([f5ece19](https://github.com/admknight/piko/commit/f5ece191a724f7bc0aed0cb90df8902f6d9e110b))
* **Translations:** Update `Japanese` ([039aac3](https://github.com/admknight/piko/commit/039aac304215858769c794684f837719edad9790))
* **Translations:** Update Russian translation ([54ba664](https://github.com/admknight/piko/commit/54ba664921218ce79218e4ce4a9a2d4d2d1cf1b6))
* **Translations:** Update Russian translation ([3606c10](https://github.com/admknight/piko/commit/3606c101ae1630c303a8ed55c4e21ab75346fbbe))
* **Translations:** Updated Brazilian Portuguese ([e25ec0e](https://github.com/admknight/piko/commit/e25ec0ecee9e576f6fe74c2bf70d750399275b7e))
* **Translations:** Updated Brazilian Portuguese ([45aac73](https://github.com/admknight/piko/commit/45aac7374731e2d3b4a24e3c22ad5aaaccbbc33a))
* **Translations:** Updated Traditional Chinese string-zh-rCN.xml ([6cc2373](https://github.com/admknight/piko/commit/6cc2373e417a1ed386a2682f970662e367033b43))
* **Translations:** Updated Traditional Chinese string-zh-rTW.xml ([6787c28](https://github.com/admknight/piko/commit/6787c28318762382d73f1eb8c6ad9abc4b2ee2e6))
* **translation:** Update Simplified Chinese translation ([4f3027a](https://github.com/admknight/piko/commit/4f3027a2279e9cd1a2cc010d190cab3551c45cd4))
* **Translation:** Update Simplified Chinese translation ([b9fe0e8](https://github.com/admknight/piko/commit/b9fe0e83a3ddd1fd2633dca6403723c4dbea32ce))
* **Twitter:** Add `Bring back twitter` patch ([b299b0c](https://github.com/admknight/piko/commit/b299b0c076a9ef68970bc57547830027d336b442))
* **twitter:** Add `Clear tracking params` patch @FrozenAlex's ([c1f3148](https://github.com/admknight/piko/commit/c1f3148c8b701d76fa518256b320552b9b8a2dd7))
* **Twitter:** Add `Custom download folder` ([7c93541](https://github.com/admknight/piko/commit/7c935415329303066cd69753bdeba9657be0f742))
* **Twitter:** Add `Custom sharing domain` patch ([8ffd36c](https://github.com/admknight/piko/commit/8ffd36c4097f3dc1de9f654b44f077e8ed1e9481))
* **Twitter:** Add `Disable chirp font` patch ([59eafd1](https://github.com/admknight/piko/commit/59eafd1ecf9459123fd8565121fd0a42404956bc))
* **Twitter:** Add `Dynamic color` patch from revanced ([d2bd0ef](https://github.com/admknight/piko/commit/d2bd0ef4a6c36650edde7c6d8c0c7587dcfb46ac))
* **Twitter:** Add `Premium settings` patch, Unlocks premium options from settings like custom app icon and custom navbar ([066e953](https://github.com/admknight/piko/commit/066e9538a983e6c261a56b1b568375132c0ca33c))
* **Twitter:** Add back settings ([5ba3580](https://github.com/admknight/piko/commit/5ba3580ec94a158c2e1043393aab76a0fae3481c))
* **twitter:** Add download patch ([b9612bf](https://github.com/admknight/piko/commit/b9612bfc69656681f3b84d0c8837e5d3dad9bc0d))
* **twitter:** Add google ads patch ([152b118](https://github.com/admknight/piko/commit/152b118737f84ebc155377ca58c7131486bad8a9))
* **twitter:** Add remove view count patch ([e31f222](https://github.com/admknight/piko/commit/e31f22278e6a5704037f3e3ed1583c25025abed8))
* **twitter:** Add selectable text patch ([ee3bcf1](https://github.com/admknight/piko/commit/ee3bcf17900dfe549a07426182a2149bcf16f87a))
* **Twitter:** Add settings for `Hide FAB` patch ([d5dde7c](https://github.com/admknight/piko/commit/d5dde7cb2e843bb0c8b90b7d1d5989bcf91e712b))
* **Twitter:** Add Settings for `Hide Live Threads` and `Hide Banner` patch ([ca474d4](https://github.com/admknight/piko/commit/ca474d4e7a1baa5f9cfcfd03a0640a4867089131))
* **Twitter:** Add Settings for `Hide Recommended Users` patch ([f43f027](https://github.com/admknight/piko/commit/f43f027ef6ab0d5ab0bc3433762e9200a3d8e50d))
* **Twitter:** Add settings for `Remove view count` patch ([67bb8ad](https://github.com/admknight/piko/commit/67bb8ad9837bdc21c2fffcad7851e67a8e37054d))
* **twitter:** Add Show sensitive media patch ([21c3fb4](https://github.com/admknight/piko/commit/21c3fb429b82acfb3a6b497c06c2a4e2ad596a9f))
* **Twitter:** Added `Ability to copy video media link` patch ([14bfdc7](https://github.com/admknight/piko/commit/14bfdc7d0b2d1fbf6644e496cbc186bd5ade3494))
* **Twitter:** Added `App Icon and NavBar Customisation` settings ([7e67d2f](https://github.com/admknight/piko/commit/7e67d2f84049007fe0b836567fd5572ad62b8a43))
* **Twitter:** Added `Control video auto scroll` patch ([7a21924](https://github.com/admknight/piko/commit/7a21924dc7f30a15feef1797b0416c91de27d1e4))
* **Twitter:** Added `Custom downloader` ([3d5941e](https://github.com/admknight/piko/commit/3d5941e226c1fb9402edeeb138c1c974026e0598))
* **Twitter:** Added `Custom translator` patch ([737fb9e](https://github.com/admknight/piko/commit/737fb9eaa0b8da7f020b93c314f5da60f961e345))
* **Twitter:** Added `Customise post font size` patch ([ea608e0](https://github.com/admknight/piko/commit/ea608e09b7b0775f38ca1914503e1b54dc7b73f9))
* **Twitter:** Added `Customize explore tabs` patch ([4be6a7f](https://github.com/admknight/piko/commit/4be6a7fe6ace42ca299d2e4bc7f9a963774f3bcd))
* **Twitter:** Added `Customize Inline action Bar items` patch ([05b06f9](https://github.com/admknight/piko/commit/05b06f9fa4a183c9626acc7fda69c0bebdbae761))
* **Twitter:** Added `Customize Navigation Bar items` patch ([9c6f59c](https://github.com/admknight/piko/commit/9c6f59cf6f40cc4d4d61b13bf496f800f452c0c1))
* **Twitter:** Added `Customize reply sort filter` patch ([121b8a6](https://github.com/admknight/piko/commit/121b8a6e9345ea462ad9cb06f7b20f863fc08d4a))
* **Twitter:** Added `Customize search suggestions` patch ([aaca565](https://github.com/admknight/piko/commit/aaca565c650d6cf4b2cbb8abf2e206efe9983cb1))
* **Twitter:** Added `Customize search tab items` patch ([9edc97a](https://github.com/admknight/piko/commit/9edc97a89e61f28a5cd9a419d167a6c51a1a9816))
* **Twitter:** Added `Customize side bar items` patch ([ca0d28f](https://github.com/admknight/piko/commit/ca0d28f96d65d7d7f300f6089029ec24e55802b4))
* **Twitter:** Added `Customize timeline top bar` patch ([245c5f6](https://github.com/admknight/piko/commit/245c5f6f8f82e98b405ec853624c3cad52ae1764))
* **Twitter:** Added `Debug Menu` patch ([7d5ca77](https://github.com/admknight/piko/commit/7d5ca77bf633a8dfcd8657d12b24bd076b2f5d11))
* **Twitter:** Added `Delete from database` patch ([d785660](https://github.com/admknight/piko/commit/d7856602786d3fb9d7a8721f05d80be97bc4fd3b))
* **Twitter:** Added `Disable auto timeline scroll on launch` patch ([b8d431e](https://github.com/admknight/piko/commit/b8d431ea44a2b53f9065c226116d86ec1fb7b70f))
* **Twitter:** Added `Enable app downgrading` patch ([9f581ce](https://github.com/admknight/piko/commit/9f581ce41b202fe7e5dfbb634a18a5bf6fb8faa5))
* **Twitter:** Added `Enable force HD videos` patch ([d316612](https://github.com/admknight/piko/commit/d3166121ac39adf45440e6888b43487e398f61e6))
* **Twitter:** Added `Enable PiP mode automatically` patch ([59d6b67](https://github.com/admknight/piko/commit/59d6b6723cbff6fa96218fb6210e2cb0b8bc1338))
* **Twitter:** Added `Feature Flag Hook` ([2328baf](https://github.com/admknight/piko/commit/2328baf92c733cf99ca364c978514b14b6aae2e0))
* **Twitter:** Added `Hide bookmark icon in timeline` ([ff66167](https://github.com/admknight/piko/commit/ff66167e5678adff4fde4e092a03b030a2a49693))
* **Twitter:** Added `Hide Buy Premium Banner` patch ([7ba6419](https://github.com/admknight/piko/commit/7ba64198f289ffac2e3d397e5bf0f1137ba2aa2b))
* **Twitter:** Added `Hide Community Notes` to mod settings ([157a32b](https://github.com/admknight/piko/commit/157a32b1e9f24157ad81c2434206f6e13404bbc3))
* **Twitter:** Added `Hide followed by context` patch ([261e1d0](https://github.com/admknight/piko/commit/261e1d0156702a4a72105b430d50e59e88795198))
* **Twitter:** Added `Hide For You` in Mod Settings ([86ea20f](https://github.com/admknight/piko/commit/86ea20f7c4309de0fcae2ba8fa2fa47990290a5a))
* **Twitter:** Added `Hide hidden replies` patch ([431acc4](https://github.com/admknight/piko/commit/431acc435675002c7d9f068b4fc3ebade2487db3))
* **Twitter:** Added `Hide immersive player` patch ([a649652](https://github.com/admknight/piko/commit/a649652c982903ac29100933122db47e9ed86d17))
* **Twitter:** Added `Hide nudge button` patch ([ad27484](https://github.com/admknight/piko/commit/ad27484f4cc0d727cf07cb4f202c8ddd6b582d67))
* **Twitter:** Added `Hide Promoted Trends` to Mod Settings ([9d29f45](https://github.com/admknight/piko/commit/9d29f45ba67ab2d682afe466c2d30af8b3421975))
* **Twitter:** Added `Patch info` section ([7f794c3](https://github.com/admknight/piko/commit/7f794c3cc88b1fd1170f43589aaff356532bb9e4))
* **Twitter:** Added `Profile tabs customisation` ([db0298b](https://github.com/admknight/piko/commit/db0298b9f0cc6066974630d29812a2e8a11e7262))
* **Twitter:** added `Reader Mode patch` ([1348099](https://github.com/admknight/piko/commit/134809970363b6eb76b15f1c76b779307a663cc6))
* **Twitter:** Added `Remove main event` patch ([806598d](https://github.com/admknight/piko/commit/806598d7154c538fb238f3d9b186746cb8c956bf))
* **Twitter:** Added `Remove premium upsell` patch ([37525de](https://github.com/admknight/piko/commit/37525de868c38254cbfd20b58d4fd077b0c14ca2))
* **Twitter:** Added `Remove Todays news` patch ([8324633](https://github.com/admknight/piko/commit/8324633509fdf61756751fdde67e5752ff3dee5c))
* **Twitter:** Added `Remove top people in search` patch ([95b5ef9](https://github.com/admknight/piko/commit/95b5ef902e6f595093b2304e5b2a8189f273389c))
* **Twitter:** Added `Remove videos for you` patch ([25934a2](https://github.com/admknight/piko/commit/25934a2b58a8eefc05d4313b623580371d964a12))
* **Twitter:** Added `Round off numbers` patch ([b1c1b13](https://github.com/admknight/piko/commit/b1c1b1361b55f08e2eba64e086943b30b2dc1212))
* **Twitter:** Added `Undo Post Patch` in mod settings ([54c722e](https://github.com/admknight/piko/commit/54c722e409e3367a9a1e42a7c51878ba81c3aa98))
* **Twitter:** added `Undo Posts Patch` ([ced73c6](https://github.com/admknight/piko/commit/ced73c6e316dbbdfaa60858ae5bc8a75b9afc3c0))
* **Twitter:** Added ability to export and import prefs & feature flags ([01cdd6b](https://github.com/admknight/piko/commit/01cdd6b7b25f08a3b258704f38c25b11aa1a9703))
* **Twitter:** Added ability to export and import prefs & feature flags ([a591133](https://github.com/admknight/piko/commit/a591133381a0b620a82d83580757300042680c85))
* **Twitter:** Added ability to reset pref and flags ([4aaeb09](https://github.com/admknight/piko/commit/4aaeb09ce6c38c6513be6293140a7e7e0b796f28))
* **Twitter:** Added Ad block hooks ([4811584](https://github.com/admknight/piko/commit/4811584abfb764c3539733818cf1d2dc96ef1349))
* **Twitter:** Added Remember filter for `Customize reply sort filter` ([24df398](https://github.com/admknight/piko/commit/24df3987e5008aeca52c11a8b20714766cdafff1))
* **Twitter:** Added tab redirects hook (for Bookmark Navbar) ([f01b418](https://github.com/admknight/piko/commit/f01b418fcc13e9fe54d845eab3bea1cd62687f9f))
* **Twitter:** Allow choosing public folder ([6c36202](https://github.com/admknight/piko/commit/6c362027f608ea2a84407d681d9b47775ccb0f4d))
* **Twitter:** Custom deeplinks ([325a281](https://github.com/admknight/piko/commit/325a281225b1379b310d8ba14629bdbae0b314e5))
* **Twitter:** Disable in favor of official patch bundle ([9a81fab](https://github.com/admknight/piko/commit/9a81fabed7457d1be967250faa548a67accc27bc))
* **Twitter:** Hide `Pinned posts by followers` ([5807471](https://github.com/admknight/piko/commit/5807471dda09eb379337f55edd650be12e66ff57))
* **Twitter:** Hide Banner ([b653c84](https://github.com/admknight/piko/commit/b653c84d4992be90386ce3e9031b138a4310b9fa))
* **Twitter:** Hide Community Notes ([ab48b40](https://github.com/admknight/piko/commit/ab48b402009c8603bd9ad9507a444742642282df))
* **Twitter:** Hide FAB ([4cdf50f](https://github.com/admknight/piko/commit/4cdf50fb036ed8596c9e4a3e3f1702ae78525d28))
* **Twitter:** Hide FAB Menu Buttons ([4f25bd6](https://github.com/admknight/piko/commit/4f25bd60888b70ccd4518a42459583b6ef8fcc54))
* **Twitter:** Hide For You ([c18f143](https://github.com/admknight/piko/commit/c18f1437882d6aba85c076a198a1a3c87067b716))
* **Twitter:** Hide Live Threads ([0202771](https://github.com/admknight/piko/commit/0202771020f97c32370d9ee7d110399eae6c264c))
* **Twitter:** Hide Promoted Trends ([1be736e](https://github.com/admknight/piko/commit/1be736e31ae11d21a62f7a3f4aad2689647ada92))
* **Twitter:** Hide Recommended Users ([2a55292](https://github.com/admknight/piko/commit/2a55292f81cd2d6f06058c8b4f347016700695eb))
* **ui:** app wide monet theming in light mode ([46f920b](https://github.com/admknight/piko/commit/46f920bd35841e3df85617aed6a439f0df114d7b))
* **ui:** full app wide material theming in dim mode replacing dark blue ([52d7444](https://github.com/admknight/piko/commit/52d74441f0ae509ec66ba04b3939c90deb4755c5))
* Update README.md ([7d801a9](https://github.com/admknight/piko/commit/7d801a983d7f36eeba927514a26d943e0ea371d5))
* use browser chooser when opening links ([cc165f4](https://github.com/admknight/piko/commit/cc165f41db4392d9dcc554ee8800333e87dc8cdf))

### Updates

* Add spanish to languages ([e9b8efd](https://github.com/admknight/piko/commit/e9b8efdb3570fa516f06a736f2709d1c166df1bf))
* **Bring back twitter:** Create strings file if not found ([9f51a5c](https://github.com/admknight/piko/commit/9f51a5cf9525e829166a5b82261abe209823eb5b))
* Change settings string id ([b9c86d7](https://github.com/admknight/piko/commit/b9c86d715c0ae4ec2da63384462be3c784db7b73))
* **Custom sharing domain:** require settings patch also turned it on by default. ([6a3777f](https://github.com/admknight/piko/commit/6a3777f0631a97dff3a31129a45cfc671e71283d))
* Enable `Customize profile tabs` patch by default ([a8543bf](https://github.com/admknight/piko/commit/a8543bf0d2eebe8a1580870b95c75a890e845ff4))
* Enable `Hide Live Threads` patch by default ([b9862b5](https://github.com/admknight/piko/commit/b9862b50b97741721448c0ea667769b0024961c9))
* **Hook feature flag:** Improve flag matching in search. ([d7f0827](https://github.com/admknight/piko/commit/d7f0827218a9501a0b2e061990ce60a0af18ba0e))
* Improve adding new buttons in share menu ([16cc3bd](https://github.com/admknight/piko/commit/16cc3bd01c03bfc800d61f0844b455c5d086422a))
* Improve quick settings appearance ([6dc27b4](https://github.com/admknight/piko/commit/6dc27b4a888d0028e455be1e1b41b83cdd7f7940))
* Improve the retrieval of the patches version ([ba940da](https://github.com/admknight/piko/commit/ba940da7b84e52345533dd3802410811b7fa4cb7))
* Improved the hooking of the recyclerview methods. also fixes the crash when opening feature flags. ([25e5bc4](https://github.com/admknight/piko/commit/25e5bc422c3893747b8fadd0744833a4ecb7b6ea))
* ReadMe ([5c421dd](https://github.com/admknight/piko/commit/5c421dd636f2f292e67f8b3fae6eecd2580cf179))
* ReadMe image size fix ([5ede8e0](https://github.com/admknight/piko/commit/5ede8e07ee1c25f85eab5f5b78dde2a46df29ed8))
* Refactor directory ([b3044c3](https://github.com/admknight/piko/commit/b3044c38b14b3e096ac624b8b54cc54abc7dd276))
* Russian translation ([42b68e9](https://github.com/admknight/piko/commit/42b68e96fccca505a60d6eb2682cbfb7f7acfb17))
* Translation updates ([509dfbb](https://github.com/admknight/piko/commit/509dfbb9e92511379406979a19b131a685229fc6))
* Translations ([d3ae8ec](https://github.com/admknight/piko/commit/d3ae8ec55dced8d7d09146c224d332f72414382a))
* **Translations:** Improved & updates polish translations ([9bbb9f4](https://github.com/admknight/piko/commit/9bbb9f4ea8c5aa3fee0be0580a281dc967f7981a))
* **Translations:** Translation updates ([4bf8a8d](https://github.com/admknight/piko/commit/4bf8a8dd954a7013a65ceee9d39521fd445d069d))
* **Translations:** Update `Indonesian (Bahasa)` ([1442b6c](https://github.com/admknight/piko/commit/1442b6c798f5fd58e1381f1e23581cc8f55ca0fc))
* **Translations:** Update `Indonesian (Bahasa)` ([b9488d6](https://github.com/admknight/piko/commit/b9488d6fed4e521f80ca9c292112130d806f77aa))
* **Translations:** Update `japanese` ([9fce4a2](https://github.com/admknight/piko/commit/9fce4a20d7db77992bd92eaa5ada75af8af56103))
* **Translations:** Update `Japanese` ([b326d10](https://github.com/admknight/piko/commit/b326d10599db407e1e922ac8d6d2694a67c6e42b))
* **Translations:** Update Brazilian Portuguese ([8745f61](https://github.com/admknight/piko/commit/8745f61c060a62152bd84ee510d835ac8346e01e))
* **Translations:** Update Brazilian Portuguese ([7de9493](https://github.com/admknight/piko/commit/7de949327844e06e1fda1946bed5555fb150b67c))
* **Translations:** Update Japanese ([61ff288](https://github.com/admknight/piko/commit/61ff288ba6aa086c984a317a52fb7228710878f5))
* **Translations:** Update polish ([9d8f4fc](https://github.com/admknight/piko/commit/9d8f4fc57174b0cc28540e29b7b9725af5e65421))
* **Translations:** Update polish translations ([6200d65](https://github.com/admknight/piko/commit/6200d657b5db4040f10ec4f82054ad440b09221c))
* **Translations:** Update Russian translation ([8b1c4c8](https://github.com/admknight/piko/commit/8b1c4c8185a482a72ecc7cdc2dbb31940660a70d))
* **Translations:** update simplified chinese translation ([3e5a8fd](https://github.com/admknight/piko/commit/3e5a8fdd07a7f7646e860a76fc81165b67b211bf))
* **Translations:** update simplified chinese translation ([b24f7cc](https://github.com/admknight/piko/commit/b24f7cca23c6b003c7246951de8a361ff5ef2dfb))
* **Translations:** Update simplified chinese translation ([147cb29](https://github.com/admknight/piko/commit/147cb29cd4e4f260fd168934584971e6620e7f9b))
* **Translations:** Update translations ([9686863](https://github.com/admknight/piko/commit/968686390263fa700488deb5d87085470267c7cf))
* **Translations:** Update Turkish translations ([bab6ae9](https://github.com/admknight/piko/commit/bab6ae97e400d89f7551eebfc1ee04f385a1c62c))
* **Translation:** Update Hindi translations [Bring back Twitter] ([20ac044](https://github.com/admknight/piko/commit/20ac044efe3f96f2cefadce6cb42a00e1a820840))
* **Twitter:** Added `Hide FAB Menu Buttons` to mod settings ([f236b52](https://github.com/admknight/piko/commit/f236b52bbebe7e712adbadcf7c4744d107282f71))
* **Twitter:** Added `Hide FAB Menu Buttons` to mod settings ([c02b443](https://github.com/admknight/piko/commit/c02b4430784d9845796999a2a254c2c6bd2aacbe))
* **Twitter:** Added `Reader Mode` patch in mod settings ([2e12945](https://github.com/admknight/piko/commit/2e12945423c540a77a93dcb1c8b0addcd149ef80))
* **Twitter:** Added hide 'Settings and privacy' in `Customize side bar items` ([cb01885](https://github.com/admknight/piko/commit/cb018852c8af8caaf4b986444208ab00a39eab41))
* **Twitter:** Added strings ([fad9b1a](https://github.com/admknight/piko/commit/fad9b1a9fd79b164c713fe35b61bad8ed3d9373b))
* **Twitter:** Added stubs to `No shortened URL` patch ([6d4f436](https://github.com/admknight/piko/commit/6d4f436f4773a667076930cbfb32eef2691b28bc))
* **Twitter:** Change Quick Btn path ([7febdf6](https://github.com/admknight/piko/commit/7febdf612212ba61638fd818121c8cc4b9db8ed8))
* **Twitter:** Enable new patches by default ([19f9149](https://github.com/admknight/piko/commit/19f9149452fafae83584508fe7ae9d594fcf5543))
* **Twitter:** Made some features to use flags ([04c366a](https://github.com/admknight/piko/commit/04c366a6cfac0e8d3ce0bcc41f61df76b6043f42))
* **Twitter:** move `Download Patch` to premium section ([5eafd76](https://github.com/admknight/piko/commit/5eafd76c1f9a702b4cbbd4d794fcd7121f2e2657))
* **Twitter:** Refactor download media patch ([f339e1a](https://github.com/admknight/piko/commit/f339e1aef9d81d01c9c7987c1f9b86f8e3cae351))
* **Twitter:** refactor mod settings ([783df63](https://github.com/admknight/piko/commit/783df6381de7ce9b6bbcfe5a3c68674810da32e0))
* **Twitter:** refactor Timeline entry Hook ([271da73](https://github.com/admknight/piko/commit/271da73408735e8a3ef83e36bd2462d072c16bf2))
* **Twitter:** Updated `Enable force HD videos` patch description ([86ea041](https://github.com/admknight/piko/commit/86ea0418d3606b6e04f8fbea8fc530aba5316f0f))
* **Twitter:** updated string ([60afc68](https://github.com/admknight/piko/commit/60afc683c4be02ba4d5cdc92879aad2e6755b14b))
* **Twitter:** Updated strings ([3cb159e](https://github.com/admknight/piko/commit/3cb159e57d66e22b7c2f638e5d0b7422a4ef2a10))
* **Twitter:** use stubs for Timeline entry Hook ([3ce1aee](https://github.com/admknight/piko/commit/3ce1aee32df656c64ba105cb45d148cd88db990a))

### Refactors

* Add `enableSettings` helper function ([7d6ebd5](https://github.com/admknight/piko/commit/7d6ebd579a32161bf782f2ce0843817dbbf8b69d))
* Add `SettingsPatch ` dependencies to patches ([6d252f8](https://github.com/admknight/piko/commit/6d252f84c6086b15e7be4a58676254748bd8ff73))
* **Custom Downloader:** Improve getting of tweet method declarations ([5237e49](https://github.com/admknight/piko/commit/5237e496140cc94fb9beb4a72057d927527dd78b))
* Improve selectable text patch name ([c399a52](https://github.com/admknight/piko/commit/c399a52030ecd18b887d890b0eeee3bb918480a2))
* Optimize imports ([2f42add](https://github.com/admknight/piko/commit/2f42add01463d36336423574b76670c6cbf2659a))
* Remove debug stuff ([c44b277](https://github.com/admknight/piko/commit/c44b27715a5456f01acef646c0dd051ebbab4ded))
* Remove TODO ([ae69e22](https://github.com/admknight/piko/commit/ae69e225d30fecf06d154f1447813ad28a4d533c))
* Suppress warnings ([3a9ef0a](https://github.com/admknight/piko/commit/3a9ef0aaa5397fe1dde69308b2f0de6b9ad4a8c1))
* **Twitter:** `Add ability to copy media link` patch ([e8ef551](https://github.com/admknight/piko/commit/e8ef5519abf64594676f0de1e0e3e01b06571079))
* **Twitter:** Add annotation ([644393d](https://github.com/admknight/piko/commit/644393da8867d8a88d7340f7ce056b6ac641700a))
* **twitter:** Add credits ([a200a08](https://github.com/admknight/piko/commit/a200a08c8f1a21d4efca530ddb64edc6e97ed67c))
* **Twitter:** Added 'Native features' section ([12d2bda](https://github.com/admknight/piko/commit/12d2bdaafd111eee81f22bdafa306c3493754c80))
* **Twitter:** Added `No shortened URL` as a settings toggle ([ea33a30](https://github.com/admknight/piko/commit/ea33a308c277e3e40e085112e970406cee64f0cd))
* **Twitter:** Added missing patches names ([b3fda95](https://github.com/admknight/piko/commit/b3fda9558251eda91e6e3b43e994a9dbcdb1daac))
* **Twitter:** Added multiple language support for `Bring back twitter` ([9eacab3](https://github.com/admknight/piko/commit/9eacab308dab4f4ea1de834d81308e9d616766c2))
* **Twitter:** Added Native download filename customization ([99a10b1](https://github.com/admknight/piko/commit/99a10b1615ffa3fb72df0ad283255e9c837a012f))
* **Twitter:** Added quick settings button in side drawer ([c0152e3](https://github.com/admknight/piko/commit/c0152e327e8b2e3fa2ad57d63c35738d4575cc98))
* **Twitter:** Added toggle for `Show sensitive media` patch ([cac4fe7](https://github.com/admknight/piko/commit/cac4fe747640e37dc9155c63f23082c44963c05d))
* **Twitter:** Arrange packages ([bc01b60](https://github.com/admknight/piko/commit/bc01b60ee99363d7004d555943fb0ef32de809db))
* **twitter:** Change directory ([565d5b8](https://github.com/admknight/piko/commit/565d5b8d04f7bfc5be1375c855a0d74cfec380e4))
* **Twitter:** Change translator icon ([bf5f027](https://github.com/admknight/piko/commit/bf5f027f80507cf0db5b3dfd208d26b131987eca))
* **Twitter:** Changed `Top Articles ` string ([b590695](https://github.com/admknight/piko/commit/b5906957cb8cda07a40e02008b5ad69ad6389637))
* **Twitter:** Combined `customize patch` into single class ([6c04aed](https://github.com/admknight/piko/commit/6c04aed5ec958cb86471d94dd1729c4ad7952c8d))
* **Twitter:** Force enable `Enable app icon settings` patch ([ee605f1](https://github.com/admknight/piko/commit/ee605f11f8c95e6b8cf5d1d1cf2357593e1ea318))
* **Twitter:** load `Utils.load()` dynamically ([5379276](https://github.com/admknight/piko/commit/53792768e4e5465559478041f51e516159c1f93f))
* **Twitter:** Major string changes ([f22fdf0](https://github.com/admknight/piko/commit/f22fdf086184f71447d2696461d76914dbef731d))
* **Twitter:** More strings refactor ([d5a629f](https://github.com/admknight/piko/commit/d5a629f39bc4c15be1914a6ab98034129ed53f64))
* **Twitter:** move comma ([e8e28c2](https://github.com/admknight/piko/commit/e8e28c2e33c04db7fba138c6f947643a9d00f3d8))
* **Twitter:** Rearrange `Bring back twitter` resources ([a476924](https://github.com/admknight/piko/commit/a47692437d7f80c44b67ff61204b02db93743b86))
* **Twitter:** refactor `Custom downloader` patch ([42cc752](https://github.com/admknight/piko/commit/42cc752c599f978f455f84ae9a917f7bb457af98))
* **Twitter:** Refactor `Custom downloader` patch ([1e966f7](https://github.com/admknight/piko/commit/1e966f7f519b7d947e0b516f8bc0ca0c55c1d623))
* **Twitter:** Refactor `Enable app icon settings` patch ([e7b3d0e](https://github.com/admknight/piko/commit/e7b3d0e3bfdfb5fc7dff3564c021c04d7d2d564c))
* **Twitter:** refactor button class Hook ([2bf411a](https://github.com/admknight/piko/commit/2bf411a61fd5181d5266d1496becf7b93f4d0d08))
* **Twitter:** refactor default feature flag hook ([6fd6001](https://github.com/admknight/piko/commit/6fd60012c74c83944fd80b57e444c3f54da5823c))
* **Twitter:** Refactor hooks filename ([2daa292](https://github.com/admknight/piko/commit/2daa2922c7225711fd1aa5d0556493e068026e0a))
* **Twitter:** refactor strings-pl ([9aacfa1](https://github.com/admknight/piko/commit/9aacfa1baf7ed0301850f30ae8053c101ef8b27b))
* **Twitter:** refactor values of list preference ([e0e5c5b](https://github.com/admknight/piko/commit/e0e5c5b8639efcd5eecd6476bc59b7f125d5b851))
* **twitter:** Remove debug code ([eef558e](https://github.com/admknight/piko/commit/eef558efe7249fc04a403841de576036c1d27f05))
* **Twitter:** Remove redundant semicolon ([67b3084](https://github.com/admknight/piko/commit/67b308464b6c8369abdd7cd6c4c00f3c879d0a4e))
* **Twitter:** Removed unused string from pt-BR ([cdb2067](https://github.com/admknight/piko/commit/cdb2067360944309a9156b71bf9776457c44c49a))
* **Twitter:** renamed 'Share menu button' fingerprints to hooks ([395c221](https://github.com/admknight/piko/commit/395c2217fc5f5b18cdc76568c3845140f76940d6))
* **Twitter:** Renamed patch `Remove Buy Premium Banner` to `Remove message prompts Banner` ([45dbad8](https://github.com/admknight/piko/commit/45dbad85abb22e0ab74d1dd0bcd977c4aeef3349))
* **Twitter:** Separated `App icon` and `Navigation icon` patch ([8a67f12](https://github.com/admknight/piko/commit/8a67f12e0430dbd06a6184a150ba75da832a2c54))
* **Twitter:** Seperated/Added `Remove superhero event` patch ([d60ee17](https://github.com/admknight/piko/commit/d60ee17294b311bb964e3cc6200465218d7baca3))
* **Twitter:** Strings in 'Customization' ([c52c2c0](https://github.com/admknight/piko/commit/c52c2c01948bdea5593636a99502d8b5c6c41dca))
* **Twitter:** Strings in 'Customization' ([a75221b](https://github.com/admknight/piko/commit/a75221b80c1d3223b88890a95ca1610432defbe2))
* **Twitter:** Strings refactor ([2db8866](https://github.com/admknight/piko/commit/2db88663e70745ef81024d896ad5204c29b1ba06))
* **Twitter:** update readme ([483d4f8](https://github.com/admknight/piko/commit/483d4f8ec9d5d9b3df49aa162bab636b23ea32d4))
* **Twitter:** updated profile tab string ([1af7846](https://github.com/admknight/piko/commit/1af78461de97661a82d5eb638300402eaab00afe))
* **Twitter:** Use addPref from integrations ([f511c38](https://github.com/admknight/piko/commit/f511c38e8bb38f2e7f041d0b8a00ed6f1f2de3e4))

### Perfomance

* **Bring back twitter:** Optimize string replacement ([#440](https://github.com/admknight/piko/issues/440)) ([7e61023](https://github.com/admknight/piko/commit/7e6102351d9488f89489f87df2ec45d6d0d178d8))
